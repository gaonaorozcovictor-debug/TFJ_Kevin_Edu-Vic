...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .modal h3 { font-size: 1.1rem; font-weight: 600; color: var(--dark); margin-bottom: 10px; }
...
<!-- Modal eliminar profesores -->
<div id="modalProfesores" class="modal-overlay">
  <div class="modal">
    <h3>🗑 Eliminar profesores</h3>
    <p>Se eliminarán todos los profesores del sistema. Los módulos quedarán sin asignar pero no se borrarán.<br><br>Esta acción <strong>no se puede deshacer</strong>.</p>
    <div class="modal-actions">
      <button class="btn btn-ghost" style="background:#eee;color:#333;" onclick="cerrarModal('profesores')">Cancelar</button>
      <a href="/asignaciones/controladores/Controlador_eliminar_datos.php?tipo=profesores" class="btn btn-danger">Sí, eliminar profesores</a>
    </div>
  </div>
</div>

<!-- Modal eliminar módulos -->
<div id="modalModulos" class="modal-overlay">
  <div class="modal">
    <h3>🗑 Eliminar módulos</h3>
    <p>Se eliminarán todos los módulos del sistema, incluyendo todas sus asignaciones actuales.<br><br>Esta acción <strong>no se puede deshacer</strong>.</p>
    <div class="modal-actions">
      <button class="btn btn-ghost" style="background:#eee;color:#333;" onclick="cerrarModal('modulos')">Cancelar</button>
      <a href="/asignaciones/controladores/Controlador_eliminar_datos.php?tipo=modulos" class="btn btn-danger">Sí, eliminar módulos</a>
    </div>
  </div>
</div>
...
<script>
  function abrirModal(tipo) {
    document.getElementById(tipo === 'profesores' ? 'modalProfesores' : 'modalModulos')
            .classList.add('open');
  }
